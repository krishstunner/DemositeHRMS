...
const VoluntaryResignationTable = () => {
  ...
  const handleFormSubmit = (values) => {
    ...
    // Update the Voluntary Resignation data with the submitted values
        ...
        {selectedEmployee && (
          <Form layout="vertical" onFinish={handleFormSubmit}>
            ...
            <Form.Item
              ...
              name="noticePeriod"
              rules={[
                { required: true, message: "Please enter the notice period" },
              ]}
            >
              <Input />
            </Form.Item>
            <Form.Item
              label="NOC's yet to be submitted"
              name="nocSubmitted"
              rules={[
                {
                  required: true,
                  message: "Please confirm if NOC's are yet to be submitted",
                },
              ]}
            >
              <Radio.Group>
...
export default VoluntaryResignationTable;
